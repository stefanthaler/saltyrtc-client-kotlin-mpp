package deprecated.signalling.messages.incoming.server.authentication
...
class ServerAuthMessage
     ...
     */
    override fun validateDestination(client: DeprecatedSaltyRTCClient) { //TODO this is for incoming messages only
